...
projetosRouter.get("/projetos", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const todosProjetos = yield Projetos_1.Projetos.findAndCountAll({
        include: [
...
projetosRouter.get("/projetos/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const projeto = yield Projetos_1.Projetos.findByPk(id);
    return res.status(200).json(projeto);
}));
projetosRouter.post("/projetos", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const projeto = yield Projetos_1.Projetos.create(Object.assign({}, req.body));
    return res.status(201).json(projeto);
}));
projetosRouter.put("/projetos/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
projetosRouter.delete("/projetos/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
