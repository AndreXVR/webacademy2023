...
dependentesRouter.get("/dependentes/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const dependente = yield Dependentes_1.Dependentes.findByPk(id);
    return res.status(200).json(dependente);
}));
dependentesRouter.get("/dependentes/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const dependente = yield Dependentes_1.Dependentes.findAll({
        where: {
            funcionarioId: id,
        },
    });
...
dependentesRouter.post("/dependentes", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const dependente = yield Dependentes_1.Dependentes.create(Object.assign({}, req.body));
...
dependentesRouter.put("/dependentes/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedDependente = yield Dependentes_1.Dependentes.findByPk(id);
...
dependentesRouter.delete("/dependentes/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const deletedDependente = yield Dependentes_1.Dependentes.findByPk(id);
