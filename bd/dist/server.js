...
const Projetos_routes_1 = require("./routes/Projetos.routes");
const Dependentes_routes_1 = require("./routes/Dependentes.routes");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (numeroVersaoAtualBanco < api_info_1.api.db.dbVersion) {
                ...
                if (versaoAtualBanco == null) {
                    yield VersaoDB_1.VersaoDB.create({ id: api_info_1.api.db.id, numeroVersao: api_info_1.api.db.dbVersion });
                }
                else {
